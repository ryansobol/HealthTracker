...
struct HealthKitService {
	...
	@concurrent
	func createStepSample(metricType: MetricType, date: Date, value: Double) async throws -> Void {
	...
	@concurrent
	func createWeightSample(metricType: MetricType, date: Date, value: Double) async throws -> Void {
